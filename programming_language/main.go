...
import (
	...
	"go/programming_language/ch2/popcount"
	"go/programming_language/ch2/practice1"
	"go/programming_language/ch2/practice3"
	"go/programming_language/ch2/practice4"
	"go/programming_language/ch2/practice5"
	"go/programming_language/ch3/comma"
	"go/programming_language/ch6/geometry"
)
